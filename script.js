                        ...
                        <main className="paper-container min-h-[800px] p-6 md:p-12 transition-colors duration-500 rounded-b-sm">
                            ...
                            {currentView === 'classes' && selectedClass && (
                                <div className="animate-fade-in">
                                    <div className="sticky top-24 z-30 -mx-4 md:-mx-12 px-4 md:px-12 bg-slate-100/90 dark:bg-[#0c120e]/95 backdrop-blur-md border-y border-brand/30 mb-8 py-2 md:py-4 shadow-lg transition-all">
                            ...
                            {currentView === 'manual_prof' && (
                                <div id="manual" className="animate-fade-in max-w-4xl mx-auto">
